...
- résout `donnees/config/experiences/cours4/`
...
- Une expérience = une intention claire (ex.: `cours4_signauxhash`, `cours4_trainmix`, `cours4_recompense`).
...
- crée `donnees/config/experiences/cours4/` s'il n'existe pas
