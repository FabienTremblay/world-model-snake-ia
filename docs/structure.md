...
## agents (catalogue plug-ins yaml) (ajout v1)

Les types d’agents sont déclarés via plug-ins YAML (pas de sélection codée en dur).

- répertoire : `services/agent_service/app/agents/`
- discovery : `agent*.yml`
- instanciation : `agent_service.app.catalogue_agents.creer_agent(id, params=...)`

Cette norme est verrouillée par des tests :
- `services/agent_service/tests/test_catalogue_plugins_v1.py`
- `services/ui_cli/tests/test_ui_cli_plugins_v1.py`
