...
class MondeSnake:
    ...
    def step(self, direction: str | None = None) -> None:
        ...
        # Convention v0 (tests + usage historique):
        # - si `direction` est None, on avance dans la direction courante.
        #   (Permet de piloter le monde en fixant `monde.direction` puis `step(None)`.)
        action = direction if direction is not None else "avant"
